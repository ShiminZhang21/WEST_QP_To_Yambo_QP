...
_________________________________________Yambo4.5 and later solution_____________
In the later solution the ypp can be used to write in the QP database. Plesae see example in West6.0QP_to_Yambo5.2
Other version could also work.
